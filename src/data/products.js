...
export const products = [
  ...
  },
  {
    ...
    description: "Engineered for the night owl. These all-black runners feature reflective materials and a breathable mesh upper for maximum comfort during city sprints.",
    price: 180.00,
    discount: 0,
    stock: 2, 
    sizes: [36, 37, 38, 39, 40, 41],
  ...
  },
  {
    ...
    description: "Inspired by the courts, built for the streets. The Aero-Glide features our signature air-cushion technology providing a cloud-like experience with every jump.",
    price: 210.00,
    discount: 0,
    stock: 15,
    sizes: [36, 37, 38, 39, 40, 41],
  ...
  },
  {
    ...
    description: "Ready for any terrain. These sneakers combine the grip of a hiking boot with the lightness of a trainer. Water-resistant and ready for your next adventure.",
    price: 165.00,
    discount: 15,
    stock: 0, 
    sizes: [36, 37, 38, 39, 40, 41],
  ...
  },
  {
    ...
    description: "Designed for high-performance athletes. The Nitro Boost Prime offers unparalleled energy return and a lockdown fit that feels like a second skin.",
    price: 230.00,
    discount: 0,
    stock: 8,
    sizes: [36, 37, 38, 39, 40, 41],
  ...
  },
  {
    ...
    description: "Beat the cold with style. These insulated hi-tops feature a thermal lining and a waterproof leather upper to keep you warm in the harshest winters.",
    price: 195.00,
    discount: 10,
    stock: 5,
    sizes: [36, 37, 38, 39, 40, 41],
  ...
  },
  {
    ...
    description: "A timeless silhouette reborn. Handcrafted with premium Italian leather, these sneakers bring a touch of luxury to your everyday rotation.",
    price: 275.00,
    discount: 0,
    stock: 3,
    sizes: [36, 37, 38, 39, 40, 41],
  ...
  },
  {
    ...
    description: "The ultimate in comfort. A fully engineered knit upper provides effortless flexibility, making it the lightest sneaker in our collection.",
    price: 150.00,
    discount: 20,
    stock: 12,
    sizes: [36, 37, 38, 39, 40, 41],
